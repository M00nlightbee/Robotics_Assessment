...
def display_data():
    ...
    for r in range(7, -1, -1):
        ...
        # ---- Print Cell Info + Vertical Walls ----#
        line = ""
        for c in range(8):
...
def main():
    ...
    brain.print("Maze exploration and mapping..... \n")
    ...
    brain.print("\nRobot driving to escape the maze using the quickest route......\n")
    drive_quickest_route(FINISH_TILE)
    brain.print("\nEscaped the maze by the fastest possible route\n")
    wait(2, SECONDS)

    brain.print("\nRobot returning back to start......\n")
